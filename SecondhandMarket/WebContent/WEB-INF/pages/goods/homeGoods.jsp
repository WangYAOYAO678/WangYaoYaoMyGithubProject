                    ...
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text2">欢迎来到【闲置物品】二手交易市场。</p>
                                <p class="text3">你，是否有太多的闲置想与他人分享，为了追求更好的生活</p>
                                <p class="text4">，我们打造了一个全新的平台——<span>闲置物品二手交易市场</p>
                                <p class="text5">这里有更多的闲置分享，更自由的话题讨论，你想要的，都在这里。</p>
                                <p class="text6">加入闲置物品二手交易市场，你的生活，应更精彩。</p>
                            </ul>
                          <!--   <div class="logoimg">
